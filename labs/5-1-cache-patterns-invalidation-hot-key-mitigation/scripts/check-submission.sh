...
# docs/review.md exists. Keeps the same rubric discipline as the rest of
# the course ("every quantitative claim cites an artifact").
...
POLICY="docs/staleness-policy.md"
if [[ ! -f "${POLICY}" ]]; then
  echo "WARN: ${POLICY} not filled in - step 7 asks for the staleness policy deliverable."
fi
